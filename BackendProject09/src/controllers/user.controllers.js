...
const logoutUser = asyncHandler (async (req, res) => {
    ...
    .json ( new ApiResponse (200, {} , "Userlogged succefully "))
})
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json( 
        new ApiResponse(200, {}, "Password change is succefully")
    )
})
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, user, "User details updated succefully")
    )
})
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, user, "User avatar update is successfully")
    )
})
